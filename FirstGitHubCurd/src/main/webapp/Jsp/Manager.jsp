	...
	function responseList(xmlHttp) {
		...
		for ( var key in userList) {
			...
			deleteCell.innerHTML = "<input type='button' value='Delete' id='"
					+ userList[key].id + "' onclick='delete(this.id)'>";
...
<body bgcolor="#290066">
	...
	<form name="manager">
		<h2>
			<font color="white"><center>Manager INFORMATION</center></font>
		</h2>
		<h3>
			<font color="white"><center>Hii &nbsp
					${manager.credentials.username}</center></font>
		</h3>
		<table border="1">
			<tr>
				<th><h4>
			...
			<tr>
				<td><h4>
						<font color="white">${manager.id}</font>
					</h4></td>
				<td><h4>
						<font color="white">${manager.firstname}</font>
					</h4></td>
				<td><h4>
						<font color="white">${manager.lastname}</font>
					</h4></td>
				<td><h4>
						<font color="white">${manager.mobilenumber}</font>
					</h4></td>
				<td><h4>
						<font color="white">${manager.credentials.username}</font>
					</h4></td>
				<td><h4>
						<font color="white">${manager.credentials.password}</font>
					</h4></td>
			</tr>
		</table>
		<input type="button" value="Userlist" onclick="getUserList()">
		<table id="userDataTable" style="display: none;"></table>
